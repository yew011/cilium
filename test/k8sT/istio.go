...
var _ = Describe("K8sIstioTest", func() {
	...
	var (
		...
		istioctlParams = "" +
			...
			" --set values.global.proxy.image=docker.io/jrajahalme/istio_proxy:1.6.14-beta.6-1" +
			" --set values.global.proxy_init.image=docker.io/jrajahalme/istio_proxy:1.6.14-beta.6-1" +
